        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh] py-8 lg:py-0">
          ...
          <div className="flex justify-center lg:justify-start order-1 lg:order-1">
            <motion.div
              ...
              className="relative"
            >
              <div className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96 relative">
                <motion.img
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left order-2 lg:order-2">
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.4 }}
              className="text-sm sm:text-base lg:text-lg text-gray-400 max-w-lg leading-relaxed mx-auto lg:mx-0"
            >
